...
![alt text](<python visuals/age_distri.png>)  
![  age](<python visuals/attr_rate_age.png>)
...
![alt text](<python visuals/job_satsf_attr.png>)
overall Job satisfaction report shows a fair job satisfaction score; though the human resource departments presents a higher number with very job satisfaction.
...
![alt text](<python visuals/edu_feild.png>)
...
![alt text](<python visuals/job_role.png>)  
Job role analysis reveals more about the educational field information. the sales reps leading the attrition movement with 39.76% followed by lap technicians, human resource and sales executives.
**Insight**
Just as pointed out, efforts must be made to make the job more attractive to these category of staff members to ensure they are not lost to competition.

### 9. JOb Level analysis

![alt text](<python visuals/job_level.png>)
Job level analysis shows a high attrition rate of staff of lower levels as compared to the other levels. Mid-level staff of level 3 also show significant high attrition rate which could also be attributed to competitors attracting talents from the company.
...
![alt text](<python visuals/salary_att.png>)
![alt text](<python visuals/attr_worklife_salary.png>)

Salary range analysis correlates with the job level analysis as staff who earn the lowest left the most followed by the mid-level staff.
While attrition was lower as salary increases, Salary did not influence work life balance.

**Insight**
Effort must be made to overhaul the benefits of these lower level staff, efforts should also be made to make the career ladder better to further reduce turn over.

### 12. Overtime and attrition

![alt text](<python visuals/overtime_attr.png>)![alt text](<python visuals/overtime_worklife balnce.png>)  
...
![alt text](<python visuals/distance_frm_home.png>)  
...
![  ](<python visuals/promotion_tenure.png>)  
...
![alt text](<python visuals/years_at_company_grps.png>)
...
![alt text](<python visuals/current_role_years.png>)
...
## Major Insights
    ...
    - overall job satisfaction report shows a fair job satisfaction score across board
    - Single people are more likely to leave.
    - staff with low job involvement were more likely to leave
    - Better salary resulted in better work life balance
